...
const PrivacyPolicy = () => {
  return (
    <div className={styles.container}>
      <h1>Privacy Policy for Curiosity Gem</h1>

      <p>
        At Curiosity Gem, accessible from blog.andrerodrigo.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        Curiosity Gem and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Curiosity Gem. This policy is not applicable to
      ...
      <p>
        Curiosity Gem follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Curiosity Gem uses cookies. These cookies are
      ...
      <p>
        ...
        advertising partners of Curiosity Gem.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Curiosity Gem, which are sent
      ...
      <p>
        Note that Curiosity Gem has no access to or control over these cookies
      ...
      <p>
        Curiosity Gem&apos;s Privacy Policy does not apply to other advertisers
      ...
      <p>
        Curiosity Gem does not knowingly collect any Personal Identifiable
